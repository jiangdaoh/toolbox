...
export default function UrlEncode() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <p className="text-gray-500 mb-6">Encode and decode URL strings and query parameters.</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div>
          ...
          <textarea className="w-full h-40 p-3 border border-gray-300 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-900 font-mono text-sm resize-y" value={input} onChange={(e) => setInput(e.target.value)} placeholder="Enter URL or text..." />
        </div>
        <div>
          <label className="block text-sm font-medium mb-1">Output</label>
          <textarea className="w-full h-40 p-3 border border-gray-300 dark:border-gray-700 rounded-lg bg-gray-50 dark:bg-gray-900 font-mono text-sm resize-y" value={output} readOnly />
        </div>
      </div>
